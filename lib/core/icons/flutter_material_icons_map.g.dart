// GENERATED by tool/generate_flutter_material_icon_map.dart
// ignore_for_file: constant_identifier_names, lines_longer_than_80_chars

import 'package:flutter/material.dart';

/// All `Icons.*` `IconData` symbols from the Flutter Material library.
/// Referencing this map links every icon: font subsetting may retain
/// a large Material font; see Flutter docs for `--tree-shake-icons`.
final Map<String, IconData> kFlutterMaterialIconsByName = <String, IconData>{
  'abc': Icons.abc,
